...
function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-50 to-slate-100 flex flex-col h-screen relative">
      {hasOverflow && (
      ...
      {/* Header */}
      <header className="bg-white/80 backdrop-blur-md border-b border-slate-200/50 px-4 lg:px-6 py-4 flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0 sticky top-0 z-20 no-print transition-all">
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-2 sm:gap-3 w-full sm:w-auto">
          ...
          <button
            ...
            className="col-span-1 sm:col-span-none flex-1 sm:flex-none bg-white border border-slate-200 hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700 text-slate-600 px-2 sm:px-4 py-2.5 rounded-xl flex items-center justify-center gap-1 sm:gap-2 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-500/10 font-medium text-xs sm:text-sm"
          >
          ...
          <button
            ...
            className="col-span-2 sm:col-span-none flex-1 sm:flex-none bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl flex items-center justify-center gap-2 transition-all duration-300 hover:-translate-y-0.5 shadow-lg shadow-blue-500/30 font-medium text-sm"
          >
